        ...
        _command(
            ...
            [
                ...
                _arg(
                    "run_id",
                    False,
                    "Run ID returned by the start command; used when fetching hook packets.",
                ),
            ],
            [
                [
            ...
            [
                ...
                "The first template starts the run; after Hermes has the returned run_id, the second template can fetch terminal/prompt hook packets.",
            ...
            template_execution="run_start_then_fetch_hooks_after_run_id",
        ),
        _command(
